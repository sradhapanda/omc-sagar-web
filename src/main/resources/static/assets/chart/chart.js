...
! function(t, e) {
    ...
    var Yt = Mt.extend({
        ...
        _resolveElementOptions: function(t, e) {
            var i, n, a, o = this.chart,
                ...
                s = t.custom || {}, l = o.options.elements.rectangle,
                d = {}, u = {
                    chart: o,
                    dataIndex: e,
                    dataset: r,
    ...
    var Kt = Mt.extend({
        ...
        updateElement: function(t, e, i) {
            var n = this,
                a = n.getMeta(),
                o = t.custom || {}, r = n.getScaleForId(a.xAxisID),
                ...
                generateLabels: function(t) {
                    ...
                    return e.labels.length && e.datasets.length ? e.labels.map(function(i, n) {
                        var a = t.getDatasetMeta(0),
                            o = e.datasets[0],
                            r = a.data[n],
                            s = r && r.custom || {}, l = t.options.elements.arc;
                        return {
                            text: i,
    ...
    var $t = Mt.extend({
        ...
        _resolveElementOptions: function(t, e) {
            var i, n, a, o = this.chart,
                r = this.getDataset(),
                s = t.custom || {}, l = o.options.elements.arc,
                d = {}, u = {
                    chart: o,
                    dataIndex: e,
                    dataset: r,
    ...
    var ne = Mt.extend({
        ...
        _resolveLineOptions: function(t) {
            var e, i, n, a = this.chart,
                ...
                r = t.custom || {}, s = a.options,
                l = s.elements.line,
                d = {}, u = ["backgroundColor", "borderWidth", "borderColor", "borderCapStyle", "borderDash", "borderDashOffset", "borderJoinStyle", "fill", "cubicInterpolationMode"];
            ...
            labels: {
                generateLabels: function(t) {
                    ...
                    return e.labels.length && e.datasets.length ? e.labels.map(function(i, n) {
                        var a = t.getDatasetMeta(0),
                            o = e.datasets[0],
                            r = a.data[n].custom || {}, s = t.options.elements.arc;
                        return {
                            text: i,
    ...
    var de = Mt.extend({
        ...
        _resolveLineOptions: function(t) {
            var e, i, n, a = this.chart,
                o = a.data.datasets[this.index],
                r = t.custom || {}, s = a.options.elements.line,
                l = {}, d = ["backgroundColor", "borderWidth", "borderColor", "borderCapStyle", "borderDash", "borderDashOffset", "borderJoinStyle", "fill"];
    ...
    default || we, _e = "$chartjs", Ce = "chartjs-size-monitor", Se = "chartjs-render-monitor", Pe = "chartjs-render-animation", Ie = ["animationstart", "webkitAnimationStart"], Ae = {
    ...
    var Ee = {
        ...
        descriptors: function(t) {
            ...
            var i = [],
                n = [],
                a = t && t.config || {}, o = a.options && a.options.plugins || {};
    ...
    function on(t) {
        var e, i = t.el._model || {}, n = t.el._scale || {}, a = t.fill,
            o = null;
    ...
    var gn = pt.extend({
        ...
        buildLabels: function() {
            var t = this,
                e = t.options.labels || {}, i = ut.callback(e.generateLabels, [t.chart], t) || [];
